...
public class MainMenuActivity extends AppCompatActivity {
    ...
    public void makeAlert(String message) {
        ...
        AlertDialog dialog = new AlertDialog.Builder(context)
                .setView(input).setTitle("Math Bubbles").setMessage(message)
    ...
    public void onPressedchangeLang(View v) {

        Log.d(TAG, "[CHANGE LANGUAGE] pressed");
        Intent i = new Intent(this, MainMenuActivity.class);
        // Start our GameActivity class via the Intent
        startActivity(i);
    }

    //ye function to call e nai ho rha :-
    public void showChangeLanguageDialog(View v) {
        final String[] listItems = {"French", "हिंदी", "اردو", "English"};
